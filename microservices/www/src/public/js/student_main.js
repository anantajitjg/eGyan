    ...
    $.ajax({
        ...
        if (total_badges > 0) {
            ...
            for (var i = total_badges - 1; i >= 0; i--) {
                ...
                badge_content += "<div class='card'><div class='image'><img class='ui image' src='/uploads/badges/" + data[i].badge_logo + "'></div><div class='content'><div class='ui center aligned tiny header'>" + data[i].name + "</div>" + points_display + "</div></div>";
            }
